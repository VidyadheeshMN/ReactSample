...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if(this.state.touched.firstname && firstname.length < 3)
            ...
            errors.firstname = "First name should be lesser than or equal to 12";

        if(this.state.touched.lastname && lastname.length < 3)
            errors.lastname = "Last name should be greater than or equal to 3";
        else if(this.state.touched.lastname && lastname.length > 12)
            errors.lastname = "Last name should be lesser than or equal to 12";
